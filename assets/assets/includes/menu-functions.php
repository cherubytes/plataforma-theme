...
function add_class_to_custom_logo() {
    ...
    $html = sprintf( '<a href="%1$s" class="col-12 col-md-2 navbar-brand p-0" rel="home" itemprop="url" style="max-width: 180px;">%2$s</a>',
    esc_url( home_url( '/' ) ),
    wp_get_attachment_image( $custom_logo_id, 'medium', false, array(
    'class' => 'img-fluid',
